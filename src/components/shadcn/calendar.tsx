  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-[#B6821C] text-neutral-50 hover:bg-[#B6821C] hover:text-neutral-50 focus:bg-[#B6821C] focus:text-neutral-50 dark:bg-neutral-50 dark:text-[#B6821C] dark:hover:bg-neutral-50 dark:hover:text-[#B6821C] dark:focus:bg-neutral-50 dark:focus:text-[#B6821C]',
        day_today:
